...
public class ParqueController {
    ...
    @GetMapping("/especies/{nombreParque}")
    public List<Object[]> getEspeciesByNombreParque(@PathVariable String nombreParque) {
        return parqueService.getEspeciesByNombreParque(nombreParque);
    }
    
    @GetMapping("/parques")
    public List<Object[]> getAllParquesWithEspecies() {
        return parqueService.getAllParquesWithEspecies();
    }
}
